...
class SdfIterator:
	...
	Split the file by the separator ($$$$), and for each
	molecule generated by this, extract the atoms, bonds, 
	and label of each.
	...
	def read_molecule(self):
		...
		Starting from the line we left off, (or 0 if beginning),
		read lines until we hit a $$$$. Remember what line number
		we started at, and where we end. pass a slice of the 
		array with these bounds to be turned into a Molecule,
		and return.
		"""
	...
	def create_molecule(self, lines):
		...
		for bonds, only get the first two elements (indices of atoms connected
		by bond).
